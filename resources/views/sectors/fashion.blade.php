...
@php
    $nav_title = 'Modest Fashion';
    $nav_icon = 'modest-fashion.svg';
    ...
    $information_box = [
        'title' => '$29.3 billion',
        'details' => 'of clothing exports to OIC* countries'
    ];
    $barchart_representation = 'Represented by $277 billion of spending by 1.9 billion Muslims on clothing (2019 est.)';
    $barchart_color = '#4f2d61';
    $barchart_target = 'Top 5 modest fashion Muslim consumer markets (2019)';
    $barchart_target_color = '#222222';
    $investments_box = [
        'summary_total' => '$3.45 million',
        'summary_text' => 'in recorded modest-fashion investments 2019/20*',
        'highlights' => [
            "Malaysian-firm Innovacia acquired Dutch sports hijab pioneer, Capsters, for an undisclosed amount.",
            "Egypt’s Dice manufacturing, a producer of sports and casual wear for men and women, raised $3.4 million."
        ]
    ];
    $legend_background = "#b064e0";
    $legend_stroke_colour = "#4c137e";
@endphp
...
@push('before_scripts')
    <script>
        // Investment deals
        window.investmentDeals = '/csv/fashion-investments-deals.csv';
        // Indicator
        window.sectorBarchartCsv = '/csv/fashion-barchart.csv';
        ...
        window.signalRadarCsv = '/csv/fashion-signal.csv';
        ...
        window.indicatorRankingCsv = '/csv/fashion-indicator.csv';
        ...
        window.impactLineCsv = '/csv/fashion-growth.csv';
        window.tradeFlowCsv = '/csv/fashion-tradeflow-v2.csv';
        window.tradeFlowConfig = {
            styles: {
                COUNTRY: "#764393",
                COUNTRY_TRADING: "#4f2d61",
                COUNTRY_BORDER: "#64367f",
                OCEAN: "#8c50ad",
                DISPUTED: "#8c50ad",
                ARROW_WIDE: "#f5f00a",
