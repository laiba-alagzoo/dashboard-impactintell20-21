define([], function() {
	...
	return {
		...
		filterSpec: {
            ...
            impacti5: {
                //Country,Country Code,Assets US$ billion,Assets Rank,GIEI Islamic Finance Rank
                "Country": {
                    type: "ignore",
                },
                "Country Code": {
		...
		csvHeaderToType: {
			...
			"year,exportingcountrycode,importingcountrycode,inthousands": "impacti",
			"year,exportingcountrycode,exportinginthousands,importingcountrycode,importinginthousands": "impacti2",
			"year,countrycode,assetsinbillion": "impacti3",
			"country,countrycode,outboundspendusbillion,travelspendrank,gieitravelrank,giesscore2": "impacti4",
            "country,countrycode,assetsusbillion,assetsrank,gieiislamicfinancerank": "impacti5",
		}
