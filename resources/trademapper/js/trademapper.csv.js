define([
	...
	loadCSVFile: function() {
		this.resetLoadErrors();
		this.csvFile = d3v5.event.target.files[0];
	...
	trimCsvColumnNames: function(csvString) {
		...
		var i,
			...
			csvHeaders = d3v5.csvParseRows(csvHeaderLine)[0],
	...
	processCSVString: function(fileText, filterSpec) {
		...
		csvData = d3v5.csvParse(fileText);
